...
<div class="container-fluid padding-0">
	...
	<div class="content-pages col-lg-10 col-xs-12 col-md-12">
		<div class="top-pages-icon col-lg-12 paddin-0">
			<div class="hidden-lg col-md-12 col-xs-12 padding-0">
				<ul id="magazine-list-mob">
					<?php
			...
			<div class="head-title col-lg-5 col-xs-8 col-md-8 paddin-0">
				<h1>
					<?php single_cat_title(); ?>
				</h1>
			</div>
			<div class="head-search-cart padding-0 col-lg-7 col-xs-4 col-md-4">
				<div class="cart-wrap">
					<div id="cart">
...
$countGoods;
		...
		<div class="prod-cont-side-pad  my-marg col-lg-9 col-xs-12 col-md-12">
			<ul id="prod-list" class="col-lg-12 col-xs-12 col-md-12">
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				<li class="col-lg-4 col-xs-12 col-md-12">
		...
		<div class="prod-nv col-lg-3 col-xs-12 col-md-12 padding-0">
			<div class="col-lg-12 col-xs-12 col-md-12"> 
			<ul id="magazine-list" class="start-to-fix hidden-xs hidden-md">
				<?php
				  $categories = get_categories('child_of=20&orderby=id');
				  foreach ($categories as $category) {
					$option = '<li><a href="/category/magazin/'.$category->category_nicename.'/">';
			...
			<div id="product-cart" class="col-lg-12 col-xs-12 col-md-12 padding-0">
			<?
